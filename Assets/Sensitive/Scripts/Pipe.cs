...
public class Pipe : MonoBehaviour
{
    ...
    public void ToggleCollectible(bool newState)
    {
        collectible.gameObject.SetActive(newState);
    }

    public void ToggleMirror(bool newState)
    {
        mirror.gameObject.SetActive(newState);
    }

    public void ReInitialize()
    {
        ToggleCollectible(false);
        ToggleMirror(false);
        ...
        float holeSize = pipesMgr.openingSize - Mathf.Clamp((float)GameManager.instance.difficulty, 0, 7) * 0.21f;
